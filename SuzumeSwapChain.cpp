...
VkResult SuzumeSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                               uint32_t *imageIndex) {
...
void SuzumeSwapChain::createSwapChain() {
...
void SuzumeSwapChain::createImageViews() {
...
void SuzumeSwapChain::createRenderPass() {
...
void SuzumeSwapChain::createFramebuffers() {
...
VkPresentModeKHR SuzumeSwapChain::chooseSwapPresentMode(
...
VkExtent2D SuzumeSwapChain::chooseSwapExtent(
...
VkFormat SuzumeSwapChain::findDepthFormat() {
